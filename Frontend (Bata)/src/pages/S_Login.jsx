...
const StaffLogin = () => {
  ...
  const handleGoogleLogin = async (response) => {
    ...
    try {
      const googleLoginResponse = await http.post(
        "/api/staff/google-login", // Use relative URL for consistency
        { tokenId },
        {
          headers: {
      ...
      console.log("User role:", data.staff.role);
      
      let dashboardPath = "/staffdashboard"; // Set a default in case no match is found
      
      switch (data.staff.role) {
        case "FulfilmentStaff":
          dashboardPath = "/fulfilmentstaffdashboard";
          break;
        case "deliveryAgent":
          dashboardPath = "/deliveryagentdashboard";
          break;
        case "standard":
          ...
          break;
        default:
          console.error("Unknown role:", data.staff.role); // Debugging
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let dashboardPath = "/defaultdashboard"; // Set a default in case no match is found
